const readingPart5Data = [
    ...
    {
        id: 'p5_mountain_v2',
        title: 'Chủ đề: Mountain (Version 2) (Đề mới cập nhật)',
        type: 'Logic (Chuẩn thi)',
        fragments: [
        ...
        key: '1-2-3-4-5-6-7',
        story: '1. Thay đổi cách nhìn về núi (Changing the perspective towards mountain) -> 2. Cảm giác thành tựu độc đáo (Unique sense of achievement) -> 3. Công khai thành tích lên MXH (Publicity of achievement) -> 4. Đặt sai thứ tự ưu tiên (The wrong priority) -> 5. Sự thật đáng lo ngại ở Everest (A disturbing revelation) -> 6. Tập trung vào tính bền vững (Focus on sustainability) -> 7. Gắn kết mối quan hệ thân thiết hơn (A more intimate relationship).'
    },
    {
        id: 'p5_mountain_v5',
        title: 'Chủ đề: Mountain (Version 5) (Đề mới cập nhật)',
        type: 'Logic (Chuẩn thi)',
        fragments: [
            'Our changing perspective towards mountains',
        ...
        key: '1-2-3-4-5-6-7',
        story: '1. Cách nhìn nhận về núi thay đổi (Our changing perspective towards mountains) -> 2. Cảm giác thành tựu độc đáo (A unique sense of achievement) -> 3. Công bố thành tích bản thân (Publicising one\'s achievements) -> 4. Ưu tiên sai lầm (The wrong priority) -> 5. Sự thật đáng lo ngại (A disturbing revelation) -> 6. Tập trung vào sự bền vững (A focus on sustainability) -> 7. Mối quan hệ gắn bó hơn (A more intimate relationship).'
    },
    {
        id: 'p5_mountain_v3',
        title: 'Chủ đề: Mountain (Version 3) (Đề mới cập nhật)',
        type: 'Logic (Chuẩn thi)',
        fragments: [
        ...
        key: '1-2-3-4-5-6-7',
        story: '1. Định nghĩa thay đổi về núi (Our changing definition of mountains) -> 2. Cảm giác hoàn thành (A sense of achievement) -> 3. Công khai thành tích cá nhân (Publicising one\'s achievements) -> 4. Sự thật đáng lo ngại được tiết lộ (A disturbing revelation) -> 5. Ưu tiên sai lầm (The wrong priority) -> 6. Tập trung vào tính bền vững (A focus on substantiality) -> 7. Mối quan hệ gắn bó mật thiết hơn (A more intimate relationship).'
    },
    {
        id: 'p5_mountain_v4',
        title: 'Chủ đề: Mountain (Version 4) (Đề mới cập nhật)',
        type: 'Logic (Chuẩn thi)',
        fragments: [
            'Changing the perspective towards mountains',
            'Unique sense of achievement',
            'Publicising of achievement',
            'A worrying priority',
        ...
        key: '1-2-3-4-5-6-7',
        story: '1. Thay đổi góc nhìn về núi (Changing the perspective towards mountains) -> 2. Cảm giác thành tựu độc đáo (Unique sense of achievement) -> 3. Công khai thành tích (Publicising of achievement) -> 4. Ưu tiên đáng lo ngại (A worrying priority) -> 5. Tiết lộ gây xôn xao (The disturbing revelation) -> 6. Tập trung hơn vào sự bền vững (More focus on sustainability) -> 7. Mối quan hệ thân mật mới (A new intimate relationship).'
    }
];